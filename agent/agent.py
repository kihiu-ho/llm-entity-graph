...
async def get_structured_entity_relationships(
    ...
    corporate structures, and business relationships.
    ...
    Returns:
        List of structured relationships with detailed metadata
    """
    ...
    return await get_structured_entity_relationships_tool(input_data)